...
const yearfunded = ref(["2025", "2024", "2023"]);
    ...
    <div v-if="isOpen" class="sidebar">
        <v-row no-gutters>
            ...
            <v-col cols="12">
                ...
                <v-select v-model="selectedFundingOrganisations" :items="fundingOrganisations" placeholder="Search..."
            ...
            <v-col cols="12">
                ...
                <div class="d-flex flex-row">
                    <div>
                        <v-label>Min:</v-label>
                        <v-text-field v-model="grantRange[0]" type="number" variant="outlined" class="v-slider-input"
                    ...
                    <div>
                        <v-label>Max:</v-label>
                        <v-text-field v-model="grantRange[1]" type="number" variant="outlined" class="v-slider-input"
                            hide-details single-line>
                            <template v-slot:append-inner>
                                <span class="append-text">€</span>
                            </template>
            ...
            <v-col cols="12">
                <h4>Impact Area</h4>
                <v-select v-model="selectedImpactAreas" :items="impactAreas" placeholder="Search..." multiple clearable>
                    <template v-slot:selection="{ item, index }">
                        <v-chip v-if="index < 1" :text="item.title"></v-chip>
                        <span v-if="index === 1" class="text-grey text-caption align-self-center">
